...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void updateCourse( String name, String dob,
                             String salary,int originalId) {
...
//        String rawQuery="update "+TABLE_NAME+" set "+NAME_COL+" = '"+name+"', "+SALARY_COL+" = '"+salary+"', "+DOB_COL+" = '"+dob+"' where id ="+originalId;
//        try {
...
//        }
    ...
    public void deleteCourse(int originalId) {
        ...
        db.delete(TABLE_NAME,"id="+originalId,new String[]{});
        db.close();
    }
    @Override
